...
import openMenu from '../../images/navigation__btn.svg';
import closeMenu from '../../images//navigation__btn-close.svg';
  ...
  return (
    <nav className='navigation'>
      <div className='navigation__container'>
        ...
        <button className={`navigation__burger ${isMenuOpen ? 'navigation__burger_open' : ''}`}
          aria-label='меню'
          onClick={toggleMenu} type='button'>
          {isMenuOpen ? <img
            className='navigation__btn-burger-close'
            alt='закрыть меню'
            src={closeMenu} /> :
            <img
